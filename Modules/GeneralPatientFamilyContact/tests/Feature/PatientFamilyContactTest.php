...
class PatientFamilyContactTest extends TestCase
{
    ...
    public function test_can_list_patient_family_contacts()
    {
        ...
        $response = $this->getJson('/api/v1/patientfamilycontacts');
    ...
    public function test_can_create_patient_family_contact()
    {
        ...
        $response = $this->postJson('/api/v1/patientfamilycontacts', $data);
    ...
    public function test_can_show_patient_family_contact()
    {
        ...
        $response = $this->getJson("/api/v1/patientfamilycontacts/{$model->id}");
    ...
    {
        $model = PatientFamilyContact::factory()->create();
        $response = $this->putJson("/api/v1/patientfamilycontacts/{$model->id}", [
    ...
    {
        $model = PatientFamilyContact::factory()->create();
        $response = $this->deleteJson("/api/v1/patientfamilycontacts/{$model->id}");
