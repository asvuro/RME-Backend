...
return new class extends Migration
{
    ...
    {
        Schema::create('spesialistik_submissions', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('encounter_local_id')->nullable();
            $table->string('use_case'); // gigi/mata/telinga/geriatri/ubm
    ...
    {
        Schema::dropIfExists('spesialistik_submissions');
    }
};
